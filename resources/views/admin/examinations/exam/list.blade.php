          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><b>Search Exam</b></h3>
              </div>
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{url('admin/examinations/exam/list')}}" class="btn btn-success" style="margin-top: 32px;">Reset</a>
                    </div>
                  </div>
                </div>
              </form>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><b>Exam List</b></h3>
              </div>
              <!-- /.card-header -->
